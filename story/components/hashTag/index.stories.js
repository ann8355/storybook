...
//             },
//             isLazyLoad: {
//                 default: boolean('isLazyLoad', true)
//             },
//             language: {
//                 default: string('language', 'zh-TW')
//             },
//             detail: {
//                 default: string('detail', '<span style="font-size: 12px;fontWeight: normal;color: #9b9b9b;">anne ． 4 粉絲</span>')
//             },
//             isRow: {
...
//             }
//         },
//         template: `<myComponent :isHandleLogin="isHandleLogin" :avatarWidth="avatarWidth" :profile="profile" :hasPopover="hasPopover" :isLazyLoad="isLazyLoad" :language="language" :detail="detail" :isRow="isRow" @handleLogin="handleLogin" />`
//     }),
//     {
//         notes: `
//         [ 版本紀錄 ]
